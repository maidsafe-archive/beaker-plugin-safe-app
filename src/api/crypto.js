 ...
 **/
module.exports.sha3Hash = (appHandle, data) => {
 ...
 **/
module.exports.getAppPubSignKey = (appHandle) => {
  return getObj(appHandle)
 ...
 **/
module.exports.getAppPubEncKey = (appHandle) => {
  return getObj(appHandle)
 ...
 **/
module.exports.generateEncKeyPair = (appHandle) => {
  return getObj(appHandle)
 ...
 **/
module.exports.getSignKeyFromRaw = (appHandle, raw) => {
  return getObj(appHandle)
 ...
 **/
module.exports.pubEncKeyKeyFromRaw = (appHandle, raw) => {
  return getObj(appHandle)
 ...
 **/
module.exports.secEncKeyKeyFromRaw = (appHandle, raw) => {
  return getObj(appHandle)
 ...
 *          )));
 **/
module.exports.generateEncKeyPairFromRaw = (appHandle, rawPublicKey, rawSecretKey) => {
  return getObj(appHandle)
 ...
 **/
module.exports.generateNonce = (appHandle) => {
  return getObj(appHandle)
